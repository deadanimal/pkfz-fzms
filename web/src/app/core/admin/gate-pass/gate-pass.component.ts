...
export class GatePassComponent implements OnInit {
  ...
  getChart() {
    let container = am4core.create("chartdivgatePass", am4core.Container);
  ...
  getChart1() {
    let chart = am4core.create("chartdivgatePass1", am4charts.PieChart);
  ...
  getChart2() {
    let chart = am4core.create("chartdivgatePass2", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("chartdivgatePass3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivgatePass4", am4charts.XYChart);
