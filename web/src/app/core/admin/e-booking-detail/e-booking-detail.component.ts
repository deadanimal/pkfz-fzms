...
@Component({
  selector: "app-e-booking-detail",
  templateUrl: "./e-booking-detail.component.html",
  styleUrls: ["./e-booking-detail.component.scss"],
})
export class EBookingDetailComponent implements OnInit {
  // Chart
  private chart: any;
  private chart1: any;
  private chart2: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdiEBookingDetail", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdiEBookingDetail1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdiEBookingDetail2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdiEBookingDetail3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdiEBookingDetail4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdiEBookingDetail5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdiEBookingDetail6", am4charts.PieChart);
