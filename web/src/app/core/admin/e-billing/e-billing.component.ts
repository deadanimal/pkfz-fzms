...
export class EBillingComponent implements OnInit {
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdiveBilling", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdiveBilling1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdiveBilling2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdiveBilling3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdiveBilling4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdiveBilling5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdiveBilling6", am4charts.PieChart);
