...
@Component({
  selector: "app-e-visitor",
  templateUrl: "./e-visitor.component.html",
  styleUrls: ["./e-visitor.component.scss"],
})
export class EVisitorComponent implements OnInit {
  // Chart
  private chart: any;
  private chart1: any;
  private chart2: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdiveVisitor", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdiveVisitor1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdiveVisitor2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdiveVisitor3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdiveVisitor4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdiveVisitor5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdiveVisitor6", am4charts.PieChart);
