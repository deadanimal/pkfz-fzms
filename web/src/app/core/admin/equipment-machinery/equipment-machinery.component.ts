...
@Component({
  selector: "app-equipment-machinery",
  templateUrl: "./equipment-machinery.component.html",
  styleUrls: ["./equipment-machinery.component.scss"],
})
export class EquipmentMachineryComponent implements OnInit {
  // Chart
  private chart: any;
  private chart1: any;
  private chart2: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivEquipMachine", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivEquipMachine1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivEquipMachine2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivEquipMachine3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivEquipMachine4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivEquipMachine5", am4charts.XYChart);
    chart.colors.step = 2;
  ...
  getChart6() {
    // pie chart
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivEquipMachine6", am4charts.PieChart);
