...
@Component({
  selector: "app-oga-submission",
  templateUrl: "./oga-submission.component.html",
  styleUrls: ["./oga-submission.component.scss"],
})
export class OgaSubmissionComponent implements OnInit {
  // Chart
  private chart: any;
  private chart1: any;
  private chart2: any;
  ...
  getChart() {
    //chart nate susoh
    let container = am4core.create("chartdivOgaSubmit", am4core.Container);
  ...
  getChart1() {
    // chart half circle
    let chart = am4core.create("chartdivOgaSubmit1", am4charts.PieChart);
  ...
  getChart2() {
    // chart ada gambo org
    let chart = am4core.create("chartdivOgaSubmit2", am4charts.XYChart);
  ...
  getChart3() {
    ...
    let chart = am4core.create("chartdivOgaSubmit3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivOgaSubmit4", am4charts.XYChart);
  ...
  getChart5() {
    // chart bar 2 line
    // let chart = am4core.create("chartReceipt", am4charts.XYChart);
    let chart = am4core.create("chartdivOgaSubmit5", am4charts.XYChart);
    chart.colors.step = 2;
    ...
    createSeries("first", "On-hold");
    createSeries("second", "Approved");
    createSeries("third", "Rejected");
