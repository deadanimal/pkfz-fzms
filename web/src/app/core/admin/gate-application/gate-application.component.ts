...
@Component({
  selector: "app-gate-application",
  templateUrl: "./gate-application.component.html",
  styleUrls: ["./gate-application.component.scss"],
})
export class GateApplicationComponent implements OnInit {
  // Chart
  private chart: any;
  private chart1: any;
  private chart2: any;
  ...
  getChart() {
    let container = am4core.create("chartdivzbSub", am4core.Container);
  ...
  getChart1() {
    let chart = am4core.create("chartdivzbSub1", am4charts.PieChart);
  ...
  getChart2() {
    let chart = am4core.create("chartdivzbSub2", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("chartdivzbSub3", am4charts.XYChart);
  ...
  getChart4() {
    ...
    let chart = am4core.create("chartdivzbSub4", am4charts.XYChart);
